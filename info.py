...
BOT_TOKEN = environ.get('BOT_TOKEN', '6938258876:AAG5_-vWJXUMZctZsoQMY3X_Htb2mY_3aYg')
# Bot settings
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002013722178').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://linksearch72:tcTnUrmSQNU0kwlL@cluster0.lysnymj.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "linksearch72")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'linksearch72')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', "-1001993019168"))
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', None))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002013722178')).split()]
